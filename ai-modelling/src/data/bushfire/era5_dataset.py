...
Original file is located at
    https://colab.research.google.com/drive/1gNjFd8blolXpY35aG6xnASmkRb5sDXse

# FireFusion ERA5 Dataset Extraction

Google Earth Engine pipeline for extracting ERA5 atmospheric weather data across Victoria using 12-hour intervals and 5 km grid cells for bushfire forecasting.
"""
...
ee.Initialize(project='firefusion-492401')
